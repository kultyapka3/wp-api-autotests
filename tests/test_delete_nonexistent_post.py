...
@pytest.mark.posts
def test_delete_nonexistent_post(api_client: WordPressApiClient, db_client: WordPressDbClient) -> None:
    nonexistent_post_id: int = 9999
    response = api_client.delete_post(post_id=nonexistent_post_id, force=True)
